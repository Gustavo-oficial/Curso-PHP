...
if(count($_POST) > 0){
    ...
    if(!filter_input(INPUT_POST, "nome")){
        $erros['nome'] = "O campo nome é obrigatorio <br>";
    }
    ...
    if(!filter_input(INPUT_POST, "nascimento")){
        ...
        if(!$data){
            $erros['nascimento'] = "Formato de data incorreto";
        }
    }
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-8">
            ...
            <input type="text" class="form-control <?= $erros['nome'] ? 'is-invalid' : ''?>"
                id="nome" name="nome" placeholder="Nome" value="<?= $_POST['nome'] ?>">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control <?= $erros['site'] ? 'is-invalid' : ''?>"
                id="site" name="site" placeholder="site" value="<?= $_POST['site'] ?>">
